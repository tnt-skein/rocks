...
dependencies = {
    ...
    'tnt-validate',
    -- Не объявлены и здесь не нужны: `vshard` — шлюз `sharded` и хранилище
    -- берут его только на узле с ролью шардирования, `config` и `net.box`
    -- встроены в Tarantool. Живые проверки стенда ставят vshard сами.
}
